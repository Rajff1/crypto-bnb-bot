...
TOKEN = os.getenv("BOT_TOKEN", "8167585407:AAFVa6-_obD1_ZI06eZlJGW-dFxa4kb32Hc")
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("Hello! 🚀 Your bot is now live on Render.")
...
if __name__ == "__main__":
    # Run Flask (Render will provide PORT environment variable)
